            ...
            if @user.present?
              ...
              playerInfoData = [
                playerInfo: {
                  ...
                  birthplace: player_info["birthplace"].to_s.presence || "--",
                  country: player_info["country"].to_s.presence || "--",
                  primary_team: player_info["primary_team"] || [],
                  logo_url: player_info["logo_url"].to_s.presence || "--",
                  playing_role: player_info["playing_role"].to_s.presence || "--",
                  batting_style: player_info["batting_style"].to_s.presence || "--",
                  bowling_style: player_info["bowling_style"].to_s.presence || "--",
                  fielding_position: player_info["fielding_position"].to_s.presence || "--",
                  recent_match: player_info["recent_match"].to_s.presence || "--",
                  recent_appearance: player_info["recent_appearance"].to_s.presence || "--",
                  fantasy_player_rating: player_info["fantasy_player_rating"].to_s.presence || "--",
                  alt_name: player_info["alt_name"].to_s.presence || "--",
                  facebook_profile: player_info["facebook_profile"].to_s.presence || "--",
                  twitter_profile: player_info["twitter_profile"].to_s.presence || "--",
                  instagram_profile: player_info["instagram_profile"].to_s.presence || "--",
                  debut_data: player_info["debut_data"].to_s.presence || "--",
